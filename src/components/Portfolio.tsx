...
export const Portfolio = () => {
  const projects = [
    ...
    },
    {
      ...
      link: "https://github.com/ayush-kushwaha/ai-chatbot"
    },
    {
      id: 4,
      ...
      link: "https://github.com/ayush-kushwaha/portfolio"
    },
    {
      id: 5,
      ...
      category: "Utility",
      link: "https://github.com/ayush-kushwaha/stopwatch"
    },
    {
      id: 6,
      ...
      category: "Utility",
      link: "https://github.com/ayush-kushwaha/calculator"
    }
  ];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project) => (
            <Card key={project.id} className="bg-slate-800/50 border-slate-700 hover:bg-slate-800/70 transition-all duration-300 transform hover:scale-105 group">
              <CardHeader>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex gap-3 pt-4">
                  {project.link && (
                    <Button variant="outline" size="sm" className="border-blue-400 text-blue-400 hover:bg-blue-400 hover:text-white flex-1">
